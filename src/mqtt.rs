...
const THING_NAME: &str = env!("THING_NAME");
const AWS_IOT_ENDPOINT: &str = env!("AWS_IOT_ENDPOINT");
const AWS_IOT_PUBLISH_TOPIC: &str = env!("AWS_IOT_PUBLISH_TOPIC");
const AWS_IOT_SUBSCRIBE_TOPIC: &str = env!("AWS_IOT_SUBSCRIBE_TOPIC");
